...
internal static class RoundedRectanglePathCreator
{
    ...
    public static GraphicsPath GetRoundRectanglePath(Rectangle rect, int topRadius, int bottomRadius)
    {
        ...
        if (bottomRadius > 0)
        {
            var arc = new Rectangle(rect.Right - bottomRadius * 2, rect.Bottom - bottomRadius * 2, bottomRadius * 2,
                bottomRadius * 2);
    ...
    public static GraphicsPath GetRoundRectanglePath(RectangleF rect, int topRadius, int bottomRadius)
    {
        ...
        if (bottomRadius > 0)
        {
            var arc = new RectangleF(rect.Right - bottomRadius * 2, rect.Bottom - bottomRadius * 2, bottomRadius * 2,
                bottomRadius * 2);
            path.AddArc(arc, 0, 90);
        }
        else
