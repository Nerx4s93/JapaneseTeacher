...
internal class ModuleScene : Scene
{
    ...
    private ThemeHeader _moduleHeader = new();
    private List<Control> _buttonLevels = new();
    ...
    private void AdjustControls()
    {
        ...
        if (_buttonLevels[_buttonLevels.Count - 1] is ButtonLevel buttonLevel1)
        {
            buttonLevel1.LevelInfomationIsPositionTop = true;
        }

        if (_buttonLevels[_buttonLevels.Count - 2] is ButtonLevel buttonLevel2)
        {
            buttonLevel2.LevelInfomationIsPositionTop = true;
        }
